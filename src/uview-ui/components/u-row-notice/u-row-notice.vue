	...
	>
		<view class="u-direction-row">
			<view class="u-icon-wrap">
				...
				<image src="@/static/images/index/Marquee-icon.png" style="width: 14px;height: 14px;"></image>
			</view>
			<view class="u-notice-box" id="u-notice-box">
				...
				>
					...
					:class="['u-type-' + type]" v-html="showText"></text>
				</view>
			</view>
			<view class="u-icon-wrap">
...
export default {
	...
	methods: {
		setIRDom(){
			var IR_dom = document.getElementById('u-notice-content');
			// IR_dom.className = 'IR-class';
			IR_dom.classList.add('m-text-right');
		},
		initSize() {
			let query = [],
				boxWidth = 0,
...
// .IR-class {
// 	animation: u-loop-animation-IR 10s linear infinite both;
// 	text-align: left;
// 	padding-right: 100%;
// 	@include vue-flex;
// 	flex-wrap: nowrap;
