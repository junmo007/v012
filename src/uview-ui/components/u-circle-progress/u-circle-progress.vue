<template>
	...
	>
		...
		<canvas
			...
			:id="elId"
			:style="{
				width: widthPx + 'px',height: widthPx + 'px'
			}"
		></canvas>
		<slot></slot>
		<!-- <view class="b" :style="{width: widthPx + 'px',height: widthPx + 'px',transform:`rotate(${topMove}deg)`} ">
			<img class="image" src="../../../static/images/ucenter/qiu.png" alt="">
		</view> -->
	</view>
</template>
...
export default {
	...
	methods: {
		...
		drawCircleByProgress(progress) {
			...
			// console.log( (Math.PI / 2 + endAngle) / Math.PI * 90)
			this.topMove = (Math.PI / 2 + endAngle) / Math.PI * 90 *2
			ctx.stroke();
			ctx.draw();
