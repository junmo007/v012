<template>
	<view class="u-countdown">
		<view class="u-countdown-col">
			<view class="u-countdown-item" :class="separator == 'textNull' ? 'u-countdown-pc' : ''" :style="[itemStyle]"
				v-if="showDays && (hideZeroDay || (!hideZeroDay && d != '00'))">
				<view class="u-countdown-time" :style="[letterStyle]">
					{{ d }}
				</view>
				<view class="u-m-t-10 m-font-12 text-yellow" v-if="separator == 'guides'">{{$t('天')}}</view>
				<view class="m-font-12" v-if="separator == 'ucenter'">{{$t('天')}}</view>
			</view>
			<view class="u-countdown-colon"
				:style="{fontSize: separatorSize + 'rpx', color: separatorColor, paddingBottom: separator == 'colon' ? '4rpx' : 0}"
				v-if="showDays && (hideZeroDay || (!hideZeroDay && d != '00'))">
				{{ separator == 'colon' ? ':' : separator == 'textNull' ? '' : $t('') }}
			</view>
		</view>
		<view class="u-countdown-col">
			<view class="u-countdown-item" :class="separator == 'textNull' ? 'u-countdown-pc' : ''" :style="[itemStyle]"
				...
				<view class="u-m-t-10 m-font-12 text-yellow" v-if="separator == 'guides'">{{$t('时')}}</view>
				<view class="m-font-12" v-if="separator == 'ucenter'">{{$t('时')}}</view>
			</view>
			<view class="u-countdown-colon"
				:style="{fontSize: separatorSize + 'rpx', color: separatorColor, paddingBottom: separator == 'colon' ? '4rpx' : 0}"
				v-if="showHours">
		...
		<view class="u-countdown-col">
			<view class="u-countdown-item" :class="separator == 'textNull' ? 'u-countdown-pc' : ''" :style="[itemStyle]"
				...
				<view class="u-m-t-10 m-font-12 text-yellow" v-if="separator == 'guides'">{{$t('分')}}</view>
				<view class="m-font-12" v-if="separator == 'ucenter'">{{$t('分')}}</view>
			</view>
			<view class="u-countdown-colon" :class="separator == 'textNull' ? 'u-countdown-pc' : ''"
				:style="{fontSize: separatorSize + 'rpx', color: separatorColor, paddingBottom: separator == 'colon' ? '4rpx' : 0}"
				v-if="showMinutes">
				{{ separator == 'colon' ? ':' : separator == 'textNull' ? '' : $t('') }}
			</view>
		...
		<view class="u-countdown-col">
			<view class="u-countdown-item" :class="separator == 'textNull' ? 'u-countdown-pc' : ''" :style="[itemStyle]"
				...
				<view class="u-m-t-10 m-font-12 text-yellow" v-if="separator == 'guides'">{{$t('秒')}}</view>
				<view class="m-font-12" style="margin-right: 20px;" v-if="separator == 'ucenter'">{{$t('秒')}}</view>
			</view>
			<view class="u-countdown-colon"
				:style="{fontSize: separatorSize + 'rpx', color: separatorColor, paddingBottom: separator == 'colon' ? '4rpx' : 0}"
...
<style scoped lang="scss">
	...
	// .u-countdown-pc {
	// 	background-color: #306DF0!important;
	// }
</style>
