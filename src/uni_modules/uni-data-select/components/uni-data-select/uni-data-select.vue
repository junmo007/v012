		...
		<view class="uni-stat-box" :class="{'uni-stat__actived': current}">
			<view class="uni-select">
				<view class="uni-select__input-box" @click="toggleSelector">
					...
					<uni-icons v-if="current && clear" type="clear" color="var(--link-color)" class="u-m-l-10" size="24"
						@click="clearVal" />
					<uni-icons v-else :type="showSelector? 'top' : 'bottom'" size="14" class="u-m-l-10"
				...
				<view class="uni-select__selector" v-if="showSelector">
					...
					<scroll-view scroll-y="true" class="uni-select__selector-scroll">
						<view class="uni-select__selector-empty" v-if="mixinDatacomResData.length === 0">
							<text>{{$t(emptyTips)}}</text>
						</view>
						<view v-else class="uni-select__selector-item" v-for="(item,index) in mixinDatacomResData"
							:key="index" @click="change(item)" :class="current == formatItemName(item)?'active':''">
							<text
...
<style lang="scss">
	...
	// 		color: #fff;
	// 		height: 35px;
	// 		border: 1px solid #181B2E !important;
